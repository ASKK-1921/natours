    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            //if (res.data.status === 'success') location.reload(true); // Will refresh current page after logging out
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/api/v1/users/updatepassword' : '/api/v1/users/updatemyprofile';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51Hqq2xE5v3BcbjtPXJ2SYFJ0DAPEWLt3esZdDDzXn6TLoDBqyzvewazl73rpJsfFfxqxfVRl8bUP6heL0hCB3bhl00AgekMl4I');
